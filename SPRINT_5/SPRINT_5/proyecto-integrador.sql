...
-- Tiempo de generación: 05-03-2020 a las 19:33:18
...
--
CREATE DATABASE IF NOT EXISTS `movies_db` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `movies_db`;
...
(22, NULL, NULL, 'Nueve Reinas', '8.0', 23, '2000-07-11 00:00:00', 200, NULL);
...
--
CREATE DATABASE IF NOT EXISTS `proyecto_integrador` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci;
